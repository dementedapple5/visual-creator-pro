...
export const InfiniteScrollExamples = () => {
    return (
        <div className="w-full py-24 overflow-hidden bg-background/50 backdrop-blur-sm relative border-y border-white/5">
            <div className="container mx-auto px-6 mb-12 text-center relative z-20">
                <h2 className="text-3xl md:text-5xl font-bold mb-6">Made with Vizion</h2>
            ...
            <div className="relative w-full">
                ...
                <div className="flex gap-4 animate-scroll-left hover:[animation-play-state:paused]" style={{ width: "max-content" }}>
                    ...
                    {examples.map((filename, i) => (
                        <div
                            key={`orig-${i}`}
                            className="relative h-[240px] aspect-video rounded-xl overflow-hidden shadow-2xl border border-white/10 group cursor-pointer transition-transform duration-300 hover:scale-[1.02] hover:shadow-primary/20"
                        >
                            <img
