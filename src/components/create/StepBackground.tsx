...
export const StepBackground = ({ data, updateData, onNext, onPrev }: StepBackgroundProps) => {
  ...
  return (
    <div className="space-y-8">
      ...
      {activeTab === "preset" && (
        <div className="space-y-6 transition-all duration-300 ease-in-out animate-in fade-in">
      ...
      {activeTab === "custom" && (
        <div className="transition-all duration-300 ease-in-out animate-in fade-in">
